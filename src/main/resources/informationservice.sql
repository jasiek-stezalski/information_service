...
--
-- Host: 127.0.0.1
-- Czas generowania: 12 Cze 2018, 11:23
...
--
-- Zrzut danych tabeli `article_error`
--

INSERT INTO `article_error` (`id_error`, `content`, `status`, `id_article`, `id_user`) VALUES
(17, 'Jest bład w 3 linii ', 'checked', 81, 3);
...
(40, 'Nie slucham radio bo lecą tylko reklamy dlatego mam zawsze w aucie skladanki z muzą', '2018-06-12 10:53:41', -3, NULL, 11),
(37, 'Przyczyna kiepskiej formy jest sam sponsor, a rzada zmian jakby to inni zawinili. Wepchnal synka za kierownice w zamian za kase, a doswiadczenia niestety sie nie kupi, trzeba je wypracowac.', '2018-06-12 10:50:38', -3, 81, 5),
(38, 'Williams ...\r\nWywalcie tych kiepskich inżynierów. \r\nWeźcie Polaków i Niemców a zespół nie bedzie miał równych sobie!!!', '2018-06-12 10:51:24', 3, 81, 11),
(39, 'Skoro jeden sponsor wybiera kierowce (czytaj syna), drugi sponsor też wybiera kierowcę to wyniki jakie sa takie sa.', '2018-06-12 10:51:56', 0, 81, 7),
(41, 'Mamy jakieś polskie radio? Oczywiście, nie tylko z nazwy? Wszystko Donek zdążył opylić, przed ucieczka do brukselki, pod wiadome skrzydełka?', '2018-06-12 10:54:17', 2, NULL, 7),
(42, 'No to będzie przynajmniej śmieszniej', '2018-06-12 10:54:57', 1, NULL, 6),
(43, 'no i bardzo dobrze, że mimo wszystko firma nie chce uciec z Polski', '2018-06-12 10:55:51', 3, 13, 6),
(44, 'taksówkarze tyle szumu robią a tak na prawdę ta ich licencja to jednorazowy wydatek ok 700 zł na kilkadziesiąt lat', '2018-06-12 10:56:16', 0, 13, 7),
(45, 'licencje wymagają modyfikacji bo są bardzo nie na czasie', '2018-06-12 10:56:40', 1, 13, 3);
...
--
-- Zrzut danych tabeli `comment_rating`
--

INSERT INTO `comment_rating` (`id_rating`, `value`, `id_comment`, `id_user`) VALUES
(67, 1, 38, 11),
(68, -1, 37, 11),
(69, -1, 39, 7),
(70, 1, 38, 7),
...
(1, '$2a$10$S.yUVHR2vSqjg2gAJQlM6uNr1A0kE290HjTyoAGUkMD5vBwOefLGq', 'user12345', b'0', NULL),
...
(34, '$2a$10$SpuawyWOJTbjvfq.5Dc7XehQZYXHE3PoebnnvUzlRwGiq04.zWm7.', 'user11111', b'0', NULL);
...
--
ALTER TABLE `article`
  MODIFY `id_article` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;

--
-- AUTO_INCREMENT dla tabeli `article_error`
--
ALTER TABLE `article_error`
  MODIFY `id_error` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `comment`
  MODIFY `id_comment` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT dla tabeli `comment_rating`
--
ALTER TABLE `comment_rating`
  MODIFY `id_rating` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT dla tabeli `picture`
--
ALTER TABLE `picture`
  MODIFY `id_picture` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `user`
  MODIFY `id_user` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
COMMIT;
