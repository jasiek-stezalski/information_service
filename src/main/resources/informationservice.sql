...
--
-- Host: 127.0.0.1
-- Czas generowania: 06 Cze 2018, 14:34
...
(107, NULL, 'sdf', 0, NULL, 'proposed', 'sdfsdf', 1, 0);
...
(34, '$2a$10$aaojW9JX/JoSezXXSUDwnOaHl2QJxi5nHSM3r5RF9qe9wPT345rz.', 'user11111', b'0', NULL);
...
--
ALTER TABLE `article`
  MODIFY `id_article` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;

--
-- AUTO_INCREMENT dla tabeli `article_error`
--
ALTER TABLE `article_error`
  MODIFY `id_error` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT dla tabeli `article_rating`
--
ALTER TABLE `article_rating`
  MODIFY `id_rating` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `user`
  MODIFY `id_user` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
COMMIT;
